...
" Website:      https://github.com/camillescott/camillionaire
" License:      MIT
" -----------------------------------------------------------------------------
...
let g:colors_name = 'camillionaire'
" }}}
" Configuration: {{{
let s:configuration = {}
let s:configuration.palette = get(g:, 'camillionaire_palette', {})
let s:configuration.transparent_background = get(g:, 'camillionaire_transparent_background', 0)
let s:configuration.disable_italic_comment = get(g:, 'camillionaire_disable_italic_comment', 0)
let s:configuration.enable_italic_string = get(g:, 'camillionaire_enable_italic_string', 0)
let s:configuration.enable_italic = get(g:, 'camillionaire_enable_italic', 0)
let s:configuration.enable_bold = get(g:, 'camillionaire_enable_bold', 1)
let s:configuration.cursor = get(g:, 'camillionaire_cursor', 'auto')
let s:configuration.current_word = get(g:, 'camillionaire_current_word', get(g:, 'camillionaire_transparent_background', 0) == 0 ? 'grey background' : 'bold')
" }}}
" Palette: {{{
let s:palette = {
...
call s:HL('StatusLine', s:palette.fg, s:palette.bg1, 'undercurl', s:palette.bg1)
call s:HL('StatusLineTerm', s:palette.fg, s:palette.bg1, 'undercurl', s:palette.bg1)
call s:HL('StatusLineNC', s:palette.grey, s:palette.bg1, 'undercurl', s:palette.bg1)
call s:HL('StatusLineTermNC', s:palette.grey, s:palette.bg1, 'undercurl', s:palette.bg1)
...
highlight! link GitGutterChange CyanSign
